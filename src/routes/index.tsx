...
function Index() {
  ...
  const showInAppNotice = isInAppBrowser && isMobileDevice;
  ...
  return (
    <main className="min-h-screen noise-bg">
      <div className={showInAppNotice ? "pointer-events-none select-none opacity-20 blur-[3px]" : ""}>
        {/* Hero */}
      ...
      {showInAppNotice && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/55 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-3xl border border-[var(--hot)]/30 bg-surface p-5 shadow-2xl">
